 ...
 * 
 *  * ************************************************
 * **  NOTE!!  This code has been customized     **
 * **          for etn application. Any changes/  **
 * **          additons have been commented.     **
 * ************************************************
 * 
...
function _42(e){
var dir=_44(e);
//Next line commented in order to allow datagrid div
if(dir==""){
...
$(this).attr("title","");
// Added for ETN.
$(this).addClass('tabIdent-' + opts.tabIdent);
//
...
$(".menu-item").last().addClass("last-item");
...
var hview=Math.max(_388.height(),_389.height());
view.height(hview);
...
var hview=Math.max(_393.height(),_394.height());
view.height(hview);
}
...
//This was added to remove the sort arrows from non-sorted columns.
if(!col.sortable){
attr+="class=\"noSort\" ";
}
//This was added to accommodate using tooltips for column headings.
if(col.tooltip){
...
//Next line changed so that the entire td would get the onclick
//event rather than just the cell text.
//_3c9.find("div.datagrid-cell").unbind(".datagrid").bind("click.datagrid",function(){
_3c9.find("div.datagrid-cell").parent().unbind(".datagrid").bind("click.datagrid",function(){
// Next line changed since we now have the parent already
// because of the change noted above. 
...
//Next line added to customize sort icon display - this removes the style
// class for the table cell that defines the sort icon. Jeff W. 08/25/2010
_3c9.find("div.datagrid-cell").parent().removeClass("datagrid-sort-asc datagrid-sort-desc");
$(this).addClass(c);
if(opts.onSortColumn){
// Next line added to customize sort icon display - this adds the style
// class for the table cell that defines the sort icon. Jeff W. 08/25/2010
...
// When we click on the row, don't check the check box. 
...
if(col){
// Next lines added to include the 'noSort' class on //
// the data cells as well.
classAdd="";
if(!col.sortable){
classAdd = " class=\"noSort\"";
}
//***End**//
